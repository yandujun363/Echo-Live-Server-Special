    ...
    config: {
        ...
        echolive: {
            ...
            layout: {
                ...
                controller: {
                    _title: "控制欄內容",
                    _description: "控制欄中的模擬按鈕，可以由文字和圖標組成。"
                }
            },
            broadcast: {
                _title: "廣播",
        ...
        editor: {
            ...
            color_picker: {
                ...
                palette: {
                    _title: "啟用的色板",
                    _description: "拾色器中有多種色板可供挑選。<br>若要挑選啟用的色板或調整排序，請反選 “全部啟用”，並在下方文本框中輸入色板名稱，一&#65279;行一&#65279;個。",
                    all_selected: "全部啟用"
                },
                contrast_enable: {
        ...
        accessibility: {
            ...
            send_on_enter: {
                _title: "按 Enter 鍵發送消息",
                _description: "只需按下 Enter 鍵即可發送消息，按下 Ctrl + Enter 鍵換行。"
            }
        },
        advanced: {
            _title: "高級設定",
            ...
            broadcast: {
                ...
                websocket_heartbeat_backoff_scale: {
                    _title: "WebSocket 心跳包並發退避比率",
                    _description: "為了減輕 WebSocket 伺服器同時連接多個客戶端時的心跳包並發壓力，心跳包會以 UUID 為種子隨機延遲 0 ~ 4095 毫秒發送。<br>調整比率可改變延遲長度。設為 0 可禁用並發退避。<br>默認的隨機範圍已足以應對常規使用場景，除非您試圖組建一個大型網絡。"
                },
                websocket_heartbeat_duration: {
                    _title: "WebSocket 心跳包間隔",
                    _description: "每一個 WebSocket 心跳包之間的間隔。並發退避不會影響間隔，只會影響偏移量。<br>設為 0 可禁用心跳包。"
                }
            },
            editor: {
                _title: "編輯器",
            ...
            device: {
                _title: "硬件設備",
                _description: "配置 Echo-Live 調用的硬件設備",
                enable: {
                    _title: "啟用硬件設備控制",
    ...
    editor: {
        ...
        log: {
            ...
            broadcast: {
                ...
                message_data_third: "收到來自其他服務端的消息數據：{message}",
            ...
            label: {
                ...
                custom_class: {
                    ...
                    style: {
                        ...
                        gradient_mountain_rock: "築山之岩",
                        gradient_night_fade: "暮色銀河",
                        gradient_premium_dark: "高級深灰",
